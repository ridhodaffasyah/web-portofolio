...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send("service_iss51ip", "template_3l0q97c", {
      from_name: form.name,
      to_name: "Ridho Daffasyah",
      from_email: form.email,
      to_email: "ridhodaffasyah01@gmail.com",
      message: form.message
    },
      "Dgn9tDLue_WsP9ciY").then(
        () => {
          setLoading(false);
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      >
        <p className={styles.sectionSubTextWhite}>
          Get in touch
        </p>
